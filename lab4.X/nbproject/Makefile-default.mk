...
SOURCEFILES_QUOTED_IF_SPACED=uart1.c ztimer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/uart1.o ${OBJECTDIR}/ztimer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/uart1.o.d ${OBJECTDIR}/ztimer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/uart1.o ${OBJECTDIR}/ztimer.o

# Source Files
SOURCEFILES=uart1.c ztimer.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/uart1.o: uart1.c  .generated_files/flags/default/d2daa9d137575f53df5538a312eaab896edbbc28 .generated_files/flags/default/c9ab9a848ec860c15d50c34be9dd107a6274ab00
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/ztimer.o: ztimer.c  .generated_files/flags/default/54186df81c7f2958d51ca5f654a5db762020e423 .generated_files/flags/default/c9ab9a848ec860c15d50c34be9dd107a6274ab00
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/ztimer.o.d 
	@${RM} ${OBJECTDIR}/ztimer.o 
	${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_SIMULATOR=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/ztimer.o.d" -o ${OBJECTDIR}/ztimer.o ztimer.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)    
